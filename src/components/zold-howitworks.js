        ...
        <div className={styles['card']}>
          ...
          <div className={styles['content-container']}>
            <span className={styles['text03']}>
              <span>
                Upload an image of a wireframe or create one using Kajooâs
          ...
          <div className={styles['content-container1']}>
            ...
            <span className={styles['text07']}>
              <span>
                ...
                your wireframes. Save them as a âstyle guideâ to reuse in future
                projects.
              </span>
            </span>
          </div>
        ...
        <div className={styles['card2']}>
          ...
          <div className={styles['content-container2']}>
            <span className={styles['text11']}>
              <span>
                Kajooâs trained AI neural network algorithms will convert your
        ...
        <div className={styles['card4']}>
          ...
          <div className={styles['content-container4']}>
            ...
            <span className={styles['text15']}>
              <span>
                Hit the âGenerate Codeâ button, import the generated code into
        ...
        <div className={styles['card5']}>
          ...
          <div className={styles['content-container5']}>
            ...
            <span className={styles['text17']}>
              <span>
                Add content, publish, and get back the hours youâd
                <span
